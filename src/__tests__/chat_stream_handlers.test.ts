...
describe("processFullResponse", () => {
  ...
  it("should process dyad-write tags and create files", async () => {
    ...
    expect(fs.mkdirSync).toHaveBeenCalledWith(
      expect.stringMatching(/mock[\\/]user[\\/]data[\\/]path[\\/]mock-app-path[\\/]src/),
      { recursive: true },
    );
    expect(fs.writeFileSync).toHaveBeenCalledWith(
      expect.stringMatching(/mock[\\/]user[\\/]data[\\/]path[\\/]mock-app-path[\\/]src[\\/]file1\.js/),
      "console.log('Hello');",
    );
  ...
  it("should process multiple dyad-write tags and commit all files", async () => {
    ...
    expect(fs.mkdirSync).toHaveBeenCalledWith(
      expect.stringMatching(/mock[\\/]user[\\/]data[\\/]path[\\/]mock-app-path[\\/]src[\\/]utils/),
      { recursive: true },
    );
    expect(fs.mkdirSync).toHaveBeenCalledWith(
      expect.stringMatching(/mock[\\/]user[\\/]data[\\/]path[\\/]mock-app-path[\\/]src[\\/]components/),
      { recursive: true },
    );
    ...
    expect(fs.writeFileSync).toHaveBeenNthCalledWith(
      2,
      expect.stringMatching(/mock[\\/]user[\\/]data[\\/]path[\\/]mock-app-path[\\/]src[\\/]utils[\\/]file2\.js/),
      "export const add = (a, b) => a + b;",
    );
    expect(fs.writeFileSync).toHaveBeenNthCalledWith(
      3,
      expect.stringMatching(/mock[\\/]user[\\/]data[\\/]path[\\/]mock-app-path[\\/]src[\\/]components[\\/]Button\.tsx/),
      "import React from 'react';\n    export const Button = ({ children }) => <button>{children}</button>;",
    );
  ...
  it("should process dyad-rename tags and rename files", async () => {
    ...
    expect(fs.renameSync).toHaveBeenCalledWith(
      expect.stringMatching(/mock[\\/]user[\\/]data[\\/]path[\\/]mock-app-path[\\/]src[\\/]components[\\/]OldComponent\.jsx/),
      expect.stringMatching(/mock[\\/]user[\\/]data[\\/]path[\\/]mock-app-path[\\/]src[\\/]components[\\/]NewComponent\.jsx/),
    );
    expect(git.add).toHaveBeenCalledWith(
      expect.objectContaining({
  ...
  it("should process dyad-delete tags and delete files", async () => {
    ...
    expect(fs.unlinkSync).toHaveBeenCalledWith(
      expect.stringMatching(/mock[\\/]user[\\/]data[\\/]path[\\/]mock-app-path[\\/]src[\\/]components[\\/]Unused\.jsx/),
    );
    expect(git.remove).toHaveBeenCalledWith(
      expect.objectContaining({
  ...
  it("should process mixed operations (write, rename, delete) in one response", async () => {
    ...
    expect(fs.renameSync).toHaveBeenCalledWith(
      expect.stringMatching(/mock[\\/]user[\\/]data[\\/]path[\\/]mock-app-path[\\/]src[\\/]components[\\/]OldComponent\.jsx/),
      expect.stringMatching(/mock[\\/]user[\\/]data[\\/]path[\\/]mock-app-path[\\/]src[\\/]components[\\/]RenamedComponent\.jsx/),
    );
